...
## Pelastustoimen haut (ei ensihoito)
...
`((fire rescue* OR fire?fighter* OR rescue service* OR emergency respon* OR emergency personnel) NOT ("medic")) AND (discriminat* OR harass* OR pressur* OR violen* OR improper behavio?r OR equal*
OR non-discriminat* OR equit*)`
...
## Pelastustoimen ja ensihoidon haku englanniksi (haku 6)

`(fire rescue* OR fire*fighter* OR rescue service* OR emergency respon* OR emergency
personnel OR "medic" OR emergency medic* OR ambulance) AND (discriminat* OR harass* OR violen* OR improper behavio?r OR equali* OR equit*)`

Sana `medic` rajataan lainausmerkeillä, koska huomattiin hakutestauksessa, että ei-sanatarkka haku tuottaa erittäin paljon epärelevanttia tulosta (lääketieteellistä tutkimusta).

Villikortti lauseessa `improper behavio?r` hakee sekä amerikkalaista että brittiläistä kirjoitusasua. Monet hakukoneet osaavat hakea tämän automaattisesti, jolloin kysymysmerkin voi jättää pois jos hakukone ei muuten tätä villikorttia tukisi.

## Muiden turvallisuustoimijoiden haut

**Suomeksi:**

`(poliisi* OR varti* OR puolustusvoim* OR sotila*) AND (syrji* OR häirin* OR häirit* OR väkival* OR painost* OR pahoinpi* OR ahdistel* OR epäasialli* OR yhdenvertai* OR tasa-arvo* OR tasapuoli* OR
tasavertai*)`
...
`(police OR guard* OR defen?e contractor* OR steward OR soldier OR military personnel) AND (discriminat* OR harass* OR pressur* OR violen* OR improper behavio?r OR equal* OR non-discriminat* OR
equit*)`
